...
//게시글 조회
app.get("/posts", threadService.readThreads);

// //게시글 작성
app.post("/posts", threadService.createThreads);

//게시글 삭제
app.delete("/posts/:id", threadService.deleteThreads);

//게시글 수정 - 받기
app.post("/posts/update", threadService.updateThreads);

//게시글 수정 - 보내기
app.get("/posts/details/:id", threadService.sendWrittenPost);

//게시글 상세보기
app.get("/posts/thread/:id", threadService.threadDetails);
